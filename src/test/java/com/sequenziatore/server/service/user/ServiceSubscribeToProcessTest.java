...
/**
 * 	File contentente la classe ServiceSubscribeToProcessTest
 * 
 *	@file		ServiceSubscribeToProcessTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceSubscribeToProcess.
 *
 *	@author 	DeSQ
 */
public class ServiceSubscribeToProcessTest {
	...
	/**
	 * Test del metodo serviceOperation() che permette ad un utente di iscriversi ad un processo.
	 * @throws Exception segnala un problema di connessione al database
	 */
	@Test
	public void testServiceOperation() throws Exception {
		ServiceSubscribeToProcess serviceSubscribeToProcessObject = new ServiceSubscribeToProcess();
        ...
        JSONObject jsonReturnedObject = serviceSubscribeToProcessObject.serviceOperation(iEntityList);
        
        assertEquals("successSubscription", jsonReturnedObject.get("Confirmation"));
        
        jsonReturnedObject = serviceSubscribeToProcessObject.serviceOperation(iEntityList);
        
        assertEquals("wrongSubscription", jsonReturnedObject.get("Confirmation"));
	}
