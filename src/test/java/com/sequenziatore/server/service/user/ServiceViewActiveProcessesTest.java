...
/**
 * 	File contentente la classe ServiceViewActiveProcessesTest
 * 
 *	@file		ServiceViewActiveProcessesTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceViewActiveProcesses.
 *
 *	@author 	DeSQ
 */
public class ServiceViewActiveProcessesTest {
	...
	/**
	 *	Test del metodo serviceOperation() che permette ad un utente di visualizzare gli attributi di tutti i processi a cui sta partecipando.
	 * @throws Exception segnala un problema di connessione al database
	 */
	@Test
    public void testServiceOperation() throws Exception {
    	ServiceViewActiveProcesses serviceViewActiveProcessesObject = new ServiceViewActiveProcesses();
    	...
    	JSONObject jsonReturnedObject = serviceViewActiveProcessesObject.serviceOperation(iEntityList);

    	assertEquals("noneSubscriptions", jsonReturnedObject.get("Confirmation"));
        ...
        jsonReturnedObject = serviceViewActiveProcessesObject.serviceOperation(iEntityList);
        
	    //estrazione dati dall'oggetto JSON
	    JSONArray jsonReturnedArray = (JSONArray) jsonReturnedObject.get("ListSubscriptions");
	    JSONObject subscriptionData = (JSONObject) jsonReturnedArray.get(0);
    	
    	assertEquals(testSubscription.getIdSubscription(), subscriptionData.get("IdSubscription"));
    }
