...
/**
 * 	File contentente la classe ServiceAvailableProcessesTest
 * 
 *	@file		ServiceAvailableProcessesTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceAvailableProcesses. 
 *
 *	@author 	DeSQ
 */
public class ServiceAvailableProcessesTest {
	...
	/**
	 *	Test del metodo serviceOperation() che permette di visualizzare i dati di tutti i processi a cui l'utente può iscriversi.
	 * @throws Exception segnala un problema di connessione al database
	 */
	@Test
    public void testServiceOperation() throws Exception {
    	ServiceAvailableProcesses serviceAvailableProcessesObject = new ServiceAvailableProcesses();
    	...
    	JSONObject jsonReturnedObject = serviceAvailableProcessesObject.serviceOperation(iEntityList);

	    assertEquals("noneProcesses", jsonReturnedObject.get("Confirmation"));
        ...
        jsonReturnedObject = serviceAvailableProcessesObject.serviceOperation(iEntityList);

	    //estrazione dati dall'oggetto JSON
	    JSONArray jsonReturnedArray = (JSONArray) jsonReturnedObject.get("ListProcesses");
