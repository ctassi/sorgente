...
/**
 * 	File contentente la classe ServiceSaveDataStepTest
 * 
 *	@file		ServiceSaveDataStepTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceSaveDataStep.
 *
 *	@author 	DeSQ
 */
public class ServiceSaveDataStepTest {
	...
	/**
	 * Test del metodo serviceOperation() che permette ad un utente di salvare i dati raccolti.
	 * @throws Exception segnala un problema di connessione al database
	 */
	@Test
	public void testServiceOperation() throws Exception {
		ServiceSaveDataStep serviceSaveDataStepObject = new ServiceSaveDataStep();
        ...
        JSONObject jsonReturnedObject = serviceSaveDataStepObject.serviceOperation(iEntityList);
        
        assertEquals("successSendData", jsonReturnedObject.get("Confirmation"));
	}
