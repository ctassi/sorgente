...
/**
 * 	File contentente la classe ServiceViewAccountTest
 * 
 *	@file		ServiceViewAccountTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceViewAccount.
 *
 *	@author 	DeSQ
 */
public class ServiceViewAccountTest {
	...
	/**
	 *	Test del metodo serviceOperation() che permette ad un utente di visualizzare i dati del proprio account.
	 * @throws Exception segnala un problema di connessione al database
	 */
    @Test
    public void testServiceOperation() throws Exception {
    	ServiceViewAccount serviceViewAccountObject = new ServiceViewAccount();
    	...
    	JSONObject jsonReturnedObject = serviceViewAccountObject.serviceOperation(iEntityList);
    	...
    	jsonReturnedObject = serviceViewAccountObject.serviceOperation(iEntityList);
    	
    	assertEquals("notReceivedInfo", jsonReturnedObject.get("Confirmation"));
    }
