...
/**
 * 	File contentente la classe ServiceListUserProcessTest
 * 
 *	@file		ServiceListUserProcessTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceListUserProcess.
 *
 *	@author 	DeSQ
 */
public class ServiceListUserProcessTest {
	...
	/**
	 *	Test del metodo serviceOperation() che permette di visualizzare gli username di tutti gli utenti che partecipano ad un processo.
	 * @throws Exception segnala un problema di connessione al database
	 */
	@Test
    public void testServiceOperation() throws Exception {
        ServiceListUserProcess serviceListUserProcessObject = new ServiceListUserProcess();
        ...
        JSONObject jsonReturnedObject = serviceListUserProcessObject.serviceOperation(iEntityList);
    	
    	assertEquals("noneUser", jsonReturnedObject.get("Confirmation"));
	    ...
	    jsonReturnedObject = serviceListUserProcessObject.serviceOperation(iEntityList);
	    
        //estrazione dati dall'oggetto JSON
	    JSONArray jsonReturnedArray = (JSONArray) jsonReturnedObject.get("ListUser");
	    JSONObject userData = (JSONObject) jsonReturnedArray.get(0);
