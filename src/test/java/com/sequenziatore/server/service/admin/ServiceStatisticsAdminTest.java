...
/**
 * 	File contentente la classe ServiceStatisticsAdminTest
 * 
 *	@file		ServiceStatisticsAdminTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceStatisticsAdmin.
 *
 *	@author 	DeSQ
 */
public class ServiceStatisticsAdminTest {
	...
	/**
	 * 	Test del metodo serviceOperation() che permette di visualizzare le statistiche sui processi creati da un amministratore.
	 * @throws Exception segnala un problema di connessione al database
	 */
	@Test
	public void testServiceOperation() throws Exception {
		ServiceStatisticsAdmin serviceStatisticsAdminObject = new ServiceStatisticsAdmin();
	    ...
	    JSONObject jsonObject = serviceStatisticsAdminObject.serviceOperation(iEntityList);
	
	    assertEquals(1, jsonObject.get("ActiveProcess"));
	    assertEquals(1, jsonObject.get("AllProcess"));
	    assertEquals(0, jsonObject.get("CloseProcess"));
	    assertEquals(1, jsonObject.get("ToVerify"));
	    //utenti non amministratori
	    assertEquals(1, jsonObject.get("AllUser"));
	}
