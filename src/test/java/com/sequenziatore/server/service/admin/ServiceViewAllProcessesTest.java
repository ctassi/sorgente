...
/**
 * 	File contentente la classe ServiceViewAllProcessesTest
 * 
 *	@file		ServiceViewAllProcessesTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceViewAllProcesses.
 *
 *	@author 	DeSQ
 */
public class ServiceViewAllProcessesTest {
	...
	/**
	 *	Test del metodo serviceOperation() che permette di visualizzare tutti i processi presenti nel sistema.
	 * @throws Exception segnala un problema di connessione al database
	 */
	@Test
    public void testServiceOperation() throws Exception {
    	ServiceViewAllProcesses serviceViewAllProcessesObject = new ServiceViewAllProcesses();
	    ...
	    JSONObject jsonReturnedObject = serviceViewAllProcessesObject.serviceOperation(iEntityList);
    	...
    	jsonReturnedObject = serviceViewAllProcessesObject.serviceOperation(iEntityList);
    	
    	assertEquals("noneProcess", jsonReturnedObject.get("Confirmation"));
	}
