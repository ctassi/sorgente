...
/**
 * 	File contentente la classe ServiceStepListValidationTest
 * 
 *	@file		ServiceStepListValidationTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceStepListValidation.
 *
 *	@author 	DeSQ
 */
public class ServiceStepListValidationTest {
	...
	/**
	 *	Test del metodo serviceOperation() che permette di visualizzare le raccolte dati che devono ancora essere validate da parte di un amministratore.
	 * @throws Exception segnala un problema di connessione al database
	 */
	@Test
    public void testServiceOperation() throws Exception {
    	ServiceStepListValidation serviceStepListValidationObject = new ServiceStepListValidation();
	    ...
	    JSONObject jsonReturnedObject = serviceStepListValidationObject.serviceOperation(iEntityList);
    	
	    //estrazione dati dall'oggetto JSON
	    JSONArray jsonReturnedArray = (JSONArray) jsonReturnedObject.get("Collections");
	    JSONObject collectionData = (JSONObject) jsonReturnedArray.get(0);
	    
    	assertEquals("test", collectionData.get("Name"));
    }
